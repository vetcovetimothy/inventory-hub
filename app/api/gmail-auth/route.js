...
export async function GET(request) {
  ...
  const params = new URLSearchParams({
    ...
    response_type: "code",
    scope: "https://www.googleapis.com/auth/gmail.compose https://www.googleapis.com/auth/gmail.settings.basic https://www.googleapis.com/auth/spreadsheets https://www.googleapis.com/auth/userinfo.email",
    access_type: "offline",
    prompt: "consent",
    state: origin,
  });
